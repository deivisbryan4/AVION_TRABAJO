    ...
    public static class DrawHelper
    {
        public static Point[] GetShipPoints(int tipo)
        {
            switch (tipo)
            {
                ...
                case 2: // Carga (Interceptor Veloz - aunque la forma parece de carga, la usaremos para el 2)
                    return new Point[] {
                ...
                case 3: // Bombardero (Bombardero Pesado)
                    return new Point[] {
                ...
                default: return new Point[] { new(0, 0), new(10, 0), new(10, 10), new(0, 10) };
            }
        }
    }
}